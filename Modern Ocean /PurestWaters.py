...
transmittance(10) #graphing transmittance at 10m
plt.plot(wavelength, trans, "ro", label="10 m") #plotting wavelength on the horizontal and transmittance on the vertical

transmittance(1) #graphing transmittance at 1m
plt.plot(wavelength, trans, "bo", label="1 m") #plotting wavelength on the horizontal and transmittance on the vertical

transmittance(0.01) #graphing transmittance at 1 cm
plt.plot(wavelength, trans, "go", label="1 cm") #plotting wavelength on the horizontal and transmittance on the vertical

#transmittance(0.000001) #graphing transmittance at 1 micro meter

plt.xlabel("Wavelength (nm)") #setting horizontal axis title
plt.ylabel("Transmittance") #setting vertical axis title
plt.title("Transmittance of the Clearest Modern Ocean Water") #setting graph title
...
plt.savefig("modernocean.pdf") #saving plot as pdf
