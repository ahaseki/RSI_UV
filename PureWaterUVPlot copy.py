...
plt.savefig('10m_trans.pdf') #save plot to file named "10m_trans"
...
plt.savefig('1m_trans.pdf') #save plot to file named "1m_trans"
plt.show() #display graph
...
plt.savefig('1cm_trans.pdf') #save plot to file named "1cm_trans"
plt.show() #display graph
...
plt.savefig('1um_trans.pdf') #save plot to file named "1um_trans"
plt.show() #display graph
